...
IERC20(tokenContract).transfer(msg.sender,availableToken);
     ...
     function setRecieverWallet(address walletAdress) public onlyOwner {
		recieverWallet=walletAdress;
        
     }
     function getRecieverWallet() public view returns (address) {
...
isallow=1;
      ...
      uint256 price=plans[currentPresaleindex-1].rate;
       ...
       if(token>0){
            ...
            payable(recieverWallet).transfer(msg.value);
       }else{
